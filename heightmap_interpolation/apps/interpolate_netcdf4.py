...
def interpolate(params):
    ...
    if params.verbose:
        ...
        ts = timer()
    xs_mat, ys_mat, elevation, mask_int, mask_ref, work_areas = load_interpolation_input_data(params.input_file,
