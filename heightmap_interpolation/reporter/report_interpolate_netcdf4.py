...
from heightmap_interpolation.reporter.interpolate_netcdf4_reporter import (
    InterpolateNetCDF4Reporter,
...
def parse_args(args=None):
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="If using this flag, the 'config_file' parameter should point to an OUTPUT file, where the default config of the reporter will be written (easy to then modify and extend at user's convenience)",
    )
